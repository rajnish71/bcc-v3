...
export const HERO_DESTINATIONS: HeroDestination[] = [
  ...
  {
    key: 'join.photowalk',
    label: 'Join · Photowalk',
    description: 'Community photowalk activity photo on the Join page (§02 Community in Action, row 1 position 1).',
    supportsFixed: true,
    supportsRotation: true,
  },
  {
    key: 'join.workshop',
    label: 'Join · Workshop',
    description: 'Workshop activity photo on the Join page (§02 Community in Action, row 1 position 2).',
    supportsFixed: true,
    supportsRotation: true,
  },
  {
    key: 'join.exhibition',
    label: 'Join · Exhibition',
    description: 'Annual exhibition activity photo on the Join page (§02 Community in Action, row 1 position 3).',
    supportsFixed: true,
    supportsRotation: true,
  },
  {
    key: 'join.travel',
    label: 'Join · Travel',
    description: 'Travel photography activity photo on the Join page (§02 Community in Action, row 2 position 1).',
    supportsFixed: true,
    supportsRotation: true,
  },
  {
    key: 'join.wildlife',
    label: 'Join · Wildlife',
    description: 'Wildlife camp activity photo on the Join page (§02 Community in Action, row 2 position 2).',
    supportsFixed: true,
    supportsRotation: true,
  },
  {
    ...
    description: 'Community / mentoring activity photo on the Join page (§02 Community in Action, row 2 position 3).',
    supportsFixed: true,
    supportsRotation: true,
  },
  {
